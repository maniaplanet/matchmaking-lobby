	...
	function getPlayerCurrentMatchId($playerLogin, $lobbyLogin, $scriptName, $titleIdString)
	{
		...
		if ($matchIds)
		{
			return $this->db->execute(
					...
					implode(', ', $matchIds),
					$this->db->quote($playerLogin),
					implode(',', array(PlayerInfo::PLAYER_STATE_QUITTER, PlayerInfo::PLAYER_STATE_REPLACER_PROPOSED, PlayerInfo::PLAYER_STATE_REPLACED, PlayerInfo::PLAYER_STATE_GIVE_UP, PlayerInfo::PLAYER_STATE_CANCEL))
